...
namespace DamageOverlay
{
    internal class Strings
    {
        ...
        public static readonly string graduated      = (PREFIX + "graduated.title").Translate();
        public static readonly string graduated_desc = (PREFIX + "graduated.desc" ).Translate();
        ...
        public static readonly string filter         = (PREFIX + "filter.title"   ).Translate();
        public static readonly string filter_desc    = (PREFIX + "filter.desc"    ).Translate();
